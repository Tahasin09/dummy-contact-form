    ...
    public function __construct()
    {
        ...
        add_action('plugins_loaded', function () {
            ...
            $updater_config = [
                ...
                'version'       => '2.5.0',  // match your plugin header
        ...
        add_filter('auto_update_plugin', array($this, 'disable_auto_update_for_dcf'), 10, 2);
...
*/
    ...
    function initialize()
    {
        include_once(MY_PLUGIN_PATH . 'src/utilities.php');
        include_once(MY_PLUGIN_PATH . 'src/options-page.php');
        include_once(MY_PLUGIN_PATH . 'src/contact-form.php');
    }
...
$dummy_contact = new Dummy_Contact_Form();
$dummy_contact->initialize();
